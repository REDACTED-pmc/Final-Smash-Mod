...
public class EntityBlast extends Entity implements IProjectile {
    ...
    public EntityBlast(World worldIn, double x, double y, double z) {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityBlast(World worldIn, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_) {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityBlast(World worldIn, EntityLivingBase shooter, float p_i1756_3_) {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = shooter;
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k)) {
                        ...
                        this.playSound("finalsmash:homerun", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                    ...
                    this.playSound("finalsmash:blaster.miss", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                    this.inGround = true;
                    this.arrowShake = 7;
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0) {
            ...
            if (this.canBePickedUp == 1 && !entityIn.inventory.addItemStackToInventory(new ItemStack(Smash.itemBlasterCell, 1))) {
                flag = false;
            }

            if (flag) {
                this.playSound("finalsmash:blaster.miss", 0.2F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
