...
public class RenderBlast extends Render {
	...
	private static final ResourceLocation blastTextures = new ResourceLocation("finalsmash:textures/entity/blast.png");

    public RenderBlast() {
        super(Minecraft.getMinecraft().getRenderManager());
    }

    public void doRender(EntityBlast p_180551_1_, double p_180551_2_, double p_180551_4_, double p_180551_6_, float p_180551_8_, float p_180551_9_) {
    ...
    protected ResourceLocation getEntityTexture(EntityBlast p_180550_1_) {
        return blastTextures;
    }

    @Override
    protected ResourceLocation getEntityTexture(Entity entity) {
        return this.getEntityTexture((EntityBlast)entity);
    }

    @Override
    public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float partialTicks) {
        this.doRender((EntityBlast)entity, x, y, z, p_76986_8_, partialTicks);
    }
